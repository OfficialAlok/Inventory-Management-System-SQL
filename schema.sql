...
-- Create view to see the current inventory status with product details
...
-- Create view to omit sensitive information of customer
CREATE VIEW `public_customers` AS
SELECT `customer_id`, `name`, `address`
FROM `customers`;

-- Create index to speed up the common searches 
